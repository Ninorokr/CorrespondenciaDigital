...
public class Main {
    ...
    static {
        Datasource.open();
        ArrayList<CanalNotificacion> canalesNotificacion = queryCanalesNotificacion();
        ArrayList<CanalRegistro> canalesRegistro = queryCanalesRegistro();
        ArrayList<Estado> estados = queryEstados();
        ArrayList<EstadoCaso> estadosCaso = queryEstadosCaso();
        ArrayList<Prioridad> prioridades = queryPrioridades();
        ArrayList<Provincia> provincias = queryProvincias();
        ArrayList<TipoAtencion> tiposAtencion = queryTiposAtencion();
        ArrayList<TipoCarta> tiposCarta = queryTiposCarta();
        ArrayList<TipoRegCaso> tiposRegCaso = queryTiposRegCaso();
        ArrayList<Usuario> usuarios = queryUsuarios();
    }
